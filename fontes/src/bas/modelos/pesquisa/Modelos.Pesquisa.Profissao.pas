...
begin
  ...
  try
    FrmTelaPesquisa.Caption:= 'Pesquisa profissões';
    FrmTelaPesquisa.AdvEdit1.LabelCaption:= 'Profissão';
    ...
    begin
      AdicionaMapaCampos( 'id_profissao', 'Código', 70 );
      AdicionaMapaCampos( 'ds_profissao', 'Profissão', 350  );
    end;
