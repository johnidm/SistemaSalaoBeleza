...
begin
  ...
  try
    FrmTelaPesquisa.Caption:= 'Pesquisa Município';
    FrmTelaPesquisa.AdvEdit1.LabelCaption:= 'Município';
    ...
    begin
      AdicionaMapaCampos( 'id_municipio', 'Código', 70 );
      AdicionaMapaCampos( 'ds_municipio', 'Município', 350  );
    end;
