inherited FrmTelaAgendaHorario: TFrmTelaAgendaHorario
  ActiveControl = BtnAgendarHorarios
  ...
  object Panel2: TPanel
    ...
    object BtnAgendarHorarios: TAdvGlassButton
      Left = 10
      Top = 93
      Width = 115
      Height = 32
      ...
      TabOrder = 1
      Version = '1.2.3.1'
      OnClick = BtnAgendarHorariosClick
    end
  end
end
